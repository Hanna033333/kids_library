...
## 🏆 공모작명: 책자리 (Kids Library) — 공공 도서관 빅데이터 및 AI 기반 맞춤형 아동 정서 큐레이션 플랫폼

### 📝 기획 의도 및 내용 요약 설명 (200자 내외)
> 정보 과잉 시대의 아동 도서 선택 피로도를 해결하기 위해, 국립중앙도서관 정보나루 실시간 API와 지자체 도서관 데이터를 활용한 정서·발달 맞춤형 그림책 큐레이션 서비스입니다. 부모의 양육 상황에 따른 도서 발견을 촉진하고 실시간 대출 상태 및 서가 내 청구기호 조회를 유기적으로 연결(Curation-to-Action)하여, 공공 도서관 자원의 대출 이용률 극대화와 아동 독서 교육 정보 격차 해소를 도모합니다.
