...
print("=" * 60)
print("'밤마다 환상축제' 책의 전체 API 응답 구조 확인")
print("=" * 60)
print()
...
try:
    ...
    if target_book:
        ...
        # 총서 관련 필드 찾기
        for key, value in target_book.items():
            if 'series' in key.lower() or '총서' in key.lower() or 'set' in key.lower():
                print(f"{key}: {value}")
