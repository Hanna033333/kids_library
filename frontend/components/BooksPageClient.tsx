...
export default function BooksPageClient({ overrideCuration, overrideAge }: BooksPageClientProps) {
    ...
    const [sortFilter, setSortFilter] = useState(() => {
        ...
        if (curation && !['겨울방학', 'winter-vacation', '여름방학', 'summer-vacation', '어린이도서연구회', 'research-council', 'caldecott'].includes(curation)) {
    ...
    const NON_AI_CURATIONS = ['겨울방학', 'winter-vacation', '여름방학', 'summer-vacation', '어린이도서연구회', 'research-council', 'caldecott'];
    ...
    useEffect(() => {
        ...
        const sort = searchParams.get('sort') || (curation && !['겨울방학', 'winter-vacation', '여름방학', 'summer-vacation', '어린이도서연구회', 'research-council', 'caldecott'].includes(curation) ? 'confidence_score_desc' : 'pangyo_callno');
    ...
    const getPageTitle = () => {
        ...
        if (curationFilter === 'summer-vacation' || curationFilter === '여름방학') return '여름방학 추천도서';
