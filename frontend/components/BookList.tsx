...
export default function BookList({
  ...
  const shouldFetchRecommended = !!(
    (ageFilter || ['caldecott', '어린이도서연구회', 'research-council', '겨울방학', 'winter-vacation', '여름방학', 'summer-vacation'].includes(curationFilter || "")) &&
    !searchQuery &&
    sortFilter === "pangyo_callno" &&
  ...
  const { data: recommendedBooks = [], isLoading: isRecommendedLoading } = useQuery<Book[]>({
    ...
    queryFn: async () => {
      ...
      if (curationFilter === "여름방학" || curationFilter === "summer-vacation") {
