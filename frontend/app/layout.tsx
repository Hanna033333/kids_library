...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      <head>
        {/* SEO Meta Tags */}
        <title>책방구 - 어린이 도서관 책 검색 | 청구기호 바로 찾기</title>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="책방구 - 어린이 도서관 책 검색" />
        <meta property="og:description" content="어린이 추천 책을 도서관 청구기호로 바로 확인하세요. 아이 책, 도서관에서 어디 있는지 쉽게 찾을 수 있어요." />
        <meta property="og:url" content="https://bookbangu.com" />
        <meta property="og:site_name" content="책방구" />
        <meta property="og:locale" content="ko_KR" />
        <meta property="og:type" content="website" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="책방구 - 어린이 도서관 책 검색" />
