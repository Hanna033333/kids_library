...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.checkjari.com"),
  title: {
    default: "주변 도서관 그림책 대출 + 연령별 큐레이션 | 책자리",
    template: "%s | 책자리"
  },
  description: "우리 동네 도서관에 이 책이 있을까? 전국 도서관 대출 상태와 청구기호를 실시간으로 확인하고, 초등 1~6학년 국어 교과서 수록도서 및 연령/정서별 엄선된 그림책 큐레이션을 만나보세요!",
  keywords: ["그림책 큐레이션", "그림책 추천", "어린이 도서", "초등 교과서 수록도서", "초등 1학년 국어 교과서 수록도서", "초등 2학년 국어 교과서 수록도서", "교과서 수록도서", "초등 국어 교과서", "초등 필독서", "잠자리 동화", "사회성 그림책", "감정조절 그림책", "책자리", "육아도서", "주변 도서관 책 검색", "도서관 대출"],
  authors: [{ name: "책자리" }],
  icons: {
    icon: '/logo.png',
    apple: '/logo.png',
