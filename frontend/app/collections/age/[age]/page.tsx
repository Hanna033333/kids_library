...
const ageMetadata: Record<string, { title: string; description: string; keywords: string }> = {
    '0-3': {
        title: '0-3세 영유아 그림책 추천 & 주변 도서관 책 검색 가능 여부 3초 확인 | 책자리',
    ...
    '4-7': {
        title: '4-7세 유아 그림책 추천 & 내 주변 도서관 책 검색 및 대출 확인 | 책자리',
    ...
    '8-12': {
        title: '초등학생 필독서 추천 & 주변 도서관 책 검색 및 실시간 대출 상태 | 책자리',
    ...
    'teen': {
        title: '청소년 필독서 추천 & 내 주변 도서관 책 검색 가능 여부 3초 확인 | 책자리',
