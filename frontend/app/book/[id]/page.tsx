...
export default function BookDetailPage() {
    ...
    return (
        <>
            <Head>
                <title>{`${book.title} - ${book.author || '작가 정보 없음'} | 책방구`}</title>
                <meta
                    name="description"
                    content={book.description || `${book.title} - ${book.author}. 도서관 청구기호: ${book.pangyo_callno || '정보 없음'}. 어린이 추천 책을 도서관에서 쉽게 찾아보세요.`}
                />
                <meta
                    name="keywords"
                    content={`${book.title}, ${book.author}, ${book.category}, 어린이 도서, 청구기호, 도서관`}
                />

                {/* Open Graph */}
                <meta property="og:title" content={`${book.title} - ${book.author || '작가 정보 없음'}`} />
                <meta
                    property="og:description"
                    content={book.description || `${book.title} - ${book.author}. 도서관 청구기호로 쉽게 찾아보세요.`}
                />
                <meta property="og:image" content={book.image_url || 'https://bookbangu.com/og-image.png'} />
                <meta property="og:url" content={`https://bookbangu.com/book/${book.id}`} />
                <meta property="og:type" content="book" />

                {/* Twitter Card */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={`${book.title} - ${book.author || '작가 정보 없음'}`} />
                <meta name="twitter:description" content={book.description || `${book.title} - ${book.author}`} />
                <meta name="twitter:image" content={book.image_url || 'https://bookbangu.com/og-image.png'} />
            </Head>
