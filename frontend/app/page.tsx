...
export const metadata: Metadata = {
  ...
  title: "책자리 - 우리 아이 맞춤 도서 큐레이션 & 도서관 청구기호 바로 찾기",
  description: "연령별·테마별로 엄선한 어린이 도서 큐레이션. 발견한 책은 도서관 청구기호로 바로 찾아보세요. 칼데콧 수상작, 어린이도서연구회 추천도서 수록.",
  keywords: "어린이 도서 추천, 유아 그림책 큐레이션, 초등 필독서, 칼데콧 수상작, 어린이도서연구회, 연령별 추천도서, 책자리, 도서관 청구기호, 판교도서관, 어린이 도서관",
  openGraph: {
    title: "책자리 - 우리 아이 맞춤 도서 큐레이션 & 도서관 청구기호 바로 찾기",
    description: "연령별·테마별로 엄선한 어린이 도서 큐레이션. 발견한 책은 도서관 청구기호로 바로 찾아보세요. 칼데콧 수상작, 어린이도서연구회 추천도서 수록.",
