...
export const ALL_TAXONOMY: CurationTag[] = [
  ...
  { id: 8, subtitle: "슬프고 낯선 이별의 감정을 안아줘요", title: "🩹 상실과 이별 그림책", tag: "상실", slug: "loss" },
  ...
  { id: 11, subtitle: "정직하게 말하는 마음의 힘", title: "💎 정직한 마음 그림책", tag: "정직", slug: "honesty" },
  { id: 12, subtitle: "나눌수록 커지는 행복의 비밀", title: "🎈 함께 나누는 기쁨", tag: "나눔", slug: "sharing" },
  { id: 13, subtitle: "폭발하는 감정을 다스리는 지혜", title: "🔥 화를 다스리는 그림책", tag: "분노조절", slug: "anger" },
  { id: 15, subtitle: "내 안의 욕심을 내려놓는 방법", title: "💚 시샘을 지우는 그림책", tag: "질투", slug: "jealousy" },
  { id: 16, subtitle: "어둠 속에서 만나는 새로운 재미", title: "🔦 밤이 무섭지 않은 책", tag: "두려움", slug: "fear" },
  ...
  { id: 19, subtitle: "소소한 일상에서 찾는 감사의 기쁨", title: "🍀 매일매일 행복 그림책", tag: "행복", slug: "happiness" },
  ...
  { id: 33, subtitle: "내 몸이 궁금한 꼬마 박사님에게", title: "🧬 신비한 우리 몸", tag: "인체", slug: "body" },
  ...
  { id: 47, subtitle: "불편함을 해소한 기발한 창의력", title: "💡 세상을 바꾼 발명", tag: "발명", slug: "invention" },
  ...
  { id: 51, subtitle: "아름다움을 느끼는 눈과 마음을 길러요", title: "🎨 감성 풍부 꼬마 예술", tag: "예술감성", slug: "art" },
  ...
  { id: 76, subtitle: "다양한 나라와 기후, 지형 탐험", title: "🗺️ 세계 지도 여행", tag: "인문지리", slug: "geography" },
